...
int oldstartC;
int replacePix =0;
int putback(int buff[16][16],int oldstartRow, int oldstartCol){
    int h=16,w=16;
    int i,j;
    int x,y;
/* TODO */
...
int show_bmp(char *p, int startRow, int startCol,int buff[16][16],int rePix,int *oldstartRow,int *oldstartCol)
{ 
 ...
 int yy=0,xx=0;
   if (rePix)
      putback(buff,*oldstartRow,*oldstartCol);
